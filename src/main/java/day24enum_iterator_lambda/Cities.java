...
public enum Cities {
    ...
    2) enumdan new keyword u ile yeni bir object oluşturamazsınız
    3) Cünkü enum içine koymuş olduğunuz her bir sabit data bu classtan oluşturulmuş bir object mantığı ile çalışır
    4) enum içerisine koymuş olduğumuz her bir sabit default olarak public static ve final keyword leri ile tanımlanmıştır
    5) bu nedenle enum içerisindeki her bir sabit data ya enum ismi yazarak nokta koyarak static bir şekilde ulaşabilirsiniz
    6) enum daki constructor yeni bir object oluşturmak için değil, enum ın içindeki her bir sabit datanın içindeki variable ları başlatmak için kullanılır
